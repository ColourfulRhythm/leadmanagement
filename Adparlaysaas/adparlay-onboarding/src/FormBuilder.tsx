...
import { FormsService, Form, Block, Question, Media } from './services/formsService';
...
const FormBuilder: React.FC = () => {
  ...
  const [media, setMedia] = useState<Media>({ type: '', url: '', primaryText: '', secondaryText: '' });
                  ...
                  <button
                    onClick={() => {
                      ...
                      if (question && question.options) {
                        ...
                        if (selectedTarget) {
                          existingLogic.push({ option, targetBlockId: selectedTarget, action: 'show' });
                        }
...
const FormPreview: React.FC<{ blocks: Block[]; questions: Question[]; media: Media }> = ({ blocks, questions, media }) => {
